...
<head>
    ...
    <link rel="shourtcut icon" type="image/png" href="assets/img/favicon1.png">
</head>
                ...
                <div class="col-md-4">
                    <div class="logo">
                        <a href="">
                            ...
                            <span>IPAM <span id="na">USL</span></span>
                        </a>
                    </div>
                </div>
    <!--================== Main menu-area ====================-->
                ...
                <div class="slider-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="slide-text">
                                    <h2>Maintaining high standards</h2>
    ...
    <footer>
        <div class="container">
            <div class="row">
                ...
                <p class="copy-right">Copyright &copy; IPAM-USL@2022</p>
            </div>
        </div>
    </footer>

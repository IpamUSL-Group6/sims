...
if (strlen($_SESSION['sid']==0)) {
  ...
  if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into  students(studentno,StudentName,course,stream,age,gender,email,parentName,relation,occupation,country,district,state,village,contactno,nextphone,studentImage) value('$studentno','$names','$course','$stream','$age','$sex','$email','$parentname','$relation','$ocupation','$country','$district','$state','$village','$phone','$nextphone','$photo')");
    if ($query) {
                      ...
                      <div class="row">
                        <div class="form-group col-md-4">
                          ...
                          <select type="select" class="form-control" id="course" name="course" required>
                            ...
                            <option value="Applied">Applied Accounting</option>
